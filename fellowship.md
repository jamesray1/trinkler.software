...
Many decisions that we took as a society were based on the _assumption_ that future generations would improve on or fix existing problems. However the current traditional systems often produces people with a _clone-like_ mindset unfit to tackle these problems.
